...
import static com.adc.tableau.tableauSever.util.enums.Operation.*;
...
public class RestApiUtils {
    ...
    private static void initialize() {
        try {
            ...
            File file = new File(restAPIConfigType.getSchemaLocation());
    ...
    private static Logger m_logger = Logger.getLogger(RestApiUtils.class);
    ...
    public PermissionsType invokeAddPermissionsToWorkbook(TableauCredentialsType credential, String siteId,
        ...
        String url = ADD_WORKBOOK_PERMISSIONS.getUrl(siteId, workbookId);
    ...
    public GroupType invokeCreateGroup(TableauCredentialsType credential, String siteId, String groupName) {
        ...
        String url = CREATE_GROUP.getUrl(siteId);
    ...
    public ProjectListType invokeQueryProjects(TableauCredentialsType credential, String siteId) {
        ...
        String url = QUERY_PROJECTS.getUrl(siteId);
    ...
    public WorkbookListType invokeQueryWorkbooks(TableauCredentialsType credential, String siteId, String userId) {
        ...
        String url = QUERY_WORKBOOKS.getUrl(siteId, userId);
    ...
    public void invokeAppendFileUpload(TableauCredentialsType credential, String siteId, String uploadSessionId,
        ...
        String url = APPEND_FILE_UPLOAD.getUrl(siteId, uploadSessionId);
    ...
    public FileUploadType invokeInitiateFileUpload(TableauCredentialsType credential, String siteId) {
        ...
        String url = INITIATE_FILE_UPLOAD.getUrl(siteId);
    ...
    private WorkbookType invokePublishWorkbookChunked(TableauCredentialsType credential, String siteId,
        ...
        UriBuilder builder = PUBLISH_WORKBOOK.getUriBuilder()
    ...
    private WorkbookType invokePublishWorkbookSimple(TableauCredentialsType credential, String siteId,
        ...
        String url = PUBLISH_WORKBOOK.getUrl(siteId);
